...
public class Map extends AbstractTileBackground {
	...
	public RPGSprite[][] layer3;	// the object/event/npc tiles

	public Map(BaseLoader bsLoader, BaseIO bsIO, String lower, String upper) {
		super(0, 0, TILE_WIDTH, TILE_HEIGHT);

		layer1 = new int[20][15];
		layer2 = new int[20][15];
		layer3 = new RPGSprite[20][15];
		...
		chipsetE = new Chipset(bsLoader.getImages("gfx/ChipSet2.png", 6, 24, false));
		chipsetF = new Chipset(bsLoader.getImages("gfx/ChipSet3.png", 6, 24));

		chipset = new Chipset[16];
		BufferedImage[] image = bsLoader.getImages("gfx/ChipSet1.png", 4, 4, false);
