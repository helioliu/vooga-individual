...
public class WinTitle extends GameObject {
	...
	public void render(Graphics2D g) {
		...
		font.drawString(g, "YOU SAVED THE WORLD, WHAT DO?", 200, 100);
		font.drawString(g, "SAVE THE WORLD AGAIN", 320, 200);
